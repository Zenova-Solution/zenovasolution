  ...
  return (
    <div className={rootClass}>
      <div className="admin-shell">
        ...
        <aside className="admin-sidebar" aria-label="Team portal navigation">
          <div className="admin-sidebar__brand">
            <LogoMark size={25} />
            <div className="admin-sidebar__brand-text">
              <div className="admin-sidebar__brand-name">Zenova</div>
              <div className="admin-sidebar__brand-tag">Team portal</div>
            </div>
            <button
              type="button"
          ...
          <nav className="admin-sidebar__nav" aria-label="Primary">
            <div className="admin-sidebar__section">Updates</div>
            {NAV.map((item) => (
              <NavLink
                key={item.to}
                to={item.to}
          ...
          <div className="admin-sidebar__footer">
            ...
            >
              ...
              <span className="admin-nav-link__label">Open client view</span>
            </Link>
          </div>
        </aside>
              ...
              <div className="admin-user-menu" ref={userMenuRef}>
                ...
                >
                  ...
                  <span className="admin-user-menu__meta">
                    <span className="admin-user-menu__name">{user?.name ?? 'Team'}</span>
                  ...
                  <div className="admin-user-menu__panel" role="menu">
                    <div className="admin-user-menu__head">
                      ...
                      <div className="admin-user-menu__head-text">
                        <div className="admin-user-menu__name">{user?.name ?? 'Team'}</div>
