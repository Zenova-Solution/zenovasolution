...
import { isTeamAuthed, teamLogin } from '@/team/store';
  ...
  return (
    <div className="adm-login">
      <form onSubmit={submit} className="adm-login__card">
        ...
        <h1 className="adm-login__title">Sign in to the team portal</h1>
        <p className="adm-login__sub">
          Update phase, dates, and status. Changes appear in the client dashboard immediately.
        </p>
        ...
        >
          Preview build · any email + 6+ char password works for the demo.
        </p>
        <a
          href="/"
          style={{
